...
customizable logo, clickable button and a general view of things. For
a while it was gone from this configuration, but now it's back.
...
#+begin_src emacs-lisp :tangle init.el
  (use-package dashboard
    ...
    (dashboard-startup-banner (concat user-emacs-directory "emacs-drawn-logo.png"))
