...
#+begin_src emacs-lisp :tangle init.el
  (defun aabm/toggle-screencasting ()
    "Toggle screencasting on and off. Using keycast-mode, display all keybindings and commands in the modeline, and using gif-screencast, record a gif of the Emacs frame."
    (interactive)
