...
*code moved to [[*mu4e][mu4e]] for performance, documentation kept here*
...
Finally, ricing. In this section we install all cosmetic packages,
such as color themes, =dashboard= and modelines, and customize them,
including face attributes and frame options.
