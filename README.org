...
#+begin_src emacs-lisp :tangle init.el
  (define-prefix-command 'aabm/search-map)
  (global-set-key (kbd "M-s") 'aabm/search-map)

  (define-prefix-command 'aabm/music-map)
  (global-set-key (kbd "C-c m") 'aabm/music-map)
#+end_src
...
#+begin_src emacs-lisp :tangle init.el
  (use-package ytel
    ...
    :custom
    (ytel-invidious-api-url "https://invidious.tube")
